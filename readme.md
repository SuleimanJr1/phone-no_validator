Phone number validator, a web app that validates and return the carrier network which that number is. Takes in country code too. Works only for Nigeria numbers only for now.
